...
(function(){
  ...
  function render(){
    ...
    root.innerHTML='<div class="card field1Finance" style="font-size:11px;color:#67e8f9">분야1위 · 투명 예산 · 정진 · 투자권유 아님</div><div class="card"><div class="row" style="justify-content:space-between"><span class="chip">한도 <b>'+s.cap.toLocaleString()+'</b></span><span class="chip">사용 <b>'+pct+'%</b></span></div>'
